package com.newsapp.ui.channel.bean;

import android.database.SQLException;
import android.util.Log;

import com.newsapp.dao.ChannelDao;
...
public class ChannelManage {
    ...
    static {
        ...
        defaultUserChannels.add(new ChannelItem(3, "体育", 3, 1));
        defaultUserChannels.add(new ChannelItem(4, "财经", 4, 1));
        defaultUserChannels.add(new ChannelItem(5, "科技", 5, 1));
        defaultUserChannels.add(new ChannelItem(6, "教育", 6, 1));
        defaultUserChannels.add(new ChannelItem(7, "军事", 7, 1));
        defaultOtherChannels.add(new ChannelItem(8, "时尚", 1, 0));
